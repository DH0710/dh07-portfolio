...
const About = () => {
    ...
    const saveFile = () => {
        ...
        FileSaver.saveAs(
            process.env.REACT_APP_CLIENT_URL + "./resume/Updated May 2023 Resume.pdf", "My_CV.pdf"
        );
    ...
    const data = [
        {
            ...
            category: "ABOUT ME",
            title: "Creative Front End Developer based in Houston, Texas",
                            ...
                            return (
                                <div>
                                    ...
                                    <div className='right-row'>
                                        ...
                                        <h2>{value.title}</h2>
                                        <p>{value.desc}</p>
                                        <button className="primary-btn" onClick ={saveFile}> <a href="./resume/Updated May 2023 Resume.pdf" download = "My_CV.pdf">
                                            Download CV
                                            </a>
                                            </button>
                                    </div>
